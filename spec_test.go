...
func TestPrev(t *testing.T) {
	runs := []struct {
		...
		{"Mon Jul 9 15:00:30 2012", "15/35 * * * * *", "Mon Jul 9 15:00:15 2012"},
		{"Mon Jul 9 15:00:50 2012", "15/35 * * * * *", "Mon Jul 9 15:00:50 2012"},

		// Wrap around hours
		{"Mon Jul 9 16:15 2012", "0 20-35/15 * * * *", "Mon Jul 9 15:35 2012"},

		// Wrap around days
		{"Tue Jul 10 0:00 2012", "0 20-35/15 * * * *", "Mon Jul 9 23:35 2012"},
		{"Tue Jul 10 0:20:14 2012", "15/35 20-35/15 * * * *", "Mon Jul 9 23:35:50 2012"},
		{"Tue Jul 10 1:20:14 2012", "15/35 20-35/15 1/2 * * *", "Mon Jul 9 23:35:50 2012"},
		{"Tue Jul 10 10:20:14 2012", "15/35 20-35/15 10-12 * * *", "Mon Jul 9 12:35:50 2012"},

		{"Wed Jul 11 01:20:14 2012", "15/35 20-35/15 1/2 */2 * *", "Mon Jul 9 23:35:50 2012"},
		{"Tue Jul 10 00:20:14 2012", "15/35 20-35/15 * 9-20 * *", "Mon Jul 9 23:35:50 2012"},
		{"Tue Jul 10 00:20:14 2012", "15/35 20-35/15 * 9-20 Jul *", "Mon Jul 9 23:35:50 2012"},

		// Wrap around months
		{"Wed Aug 8 00:00 2012", "0 0 0 9 Apr-Oct ?", "Mon Jul 9 0:00 2012"},
		{"Mon Jul 9 23:35 2012", "0 0 0 */5 Apr,Aug,Oct ?", "Mon Apr 26 00:00 2012"},
		{"Thu Nov 9 23:35 2012", "0 0 0 */5 Oct Mon", "Tue Oct 31 00:00 2012"},

		// Wrap around years
		{"Mon Jul 9 23:35 2012", "0 0 0 * Aug Mon", "Mon Aug 29 00:00 2011"},
		{"Mon Jul 9 23:35 2012", "0 0 0 * Aug Mon/2", "Fri Aug 31 00:00 2011"},

		// Wrap around minute, hour, day, month, and year
		{"Tue Jan 1 00:00:00 2013", "45 * * * * *", "Mon Dec 31 23:59:45 2012"},

		// Leap year
		{"Mon Jan 9 23:35 2012", "0 0 0 29 Feb ?", "Fri Feb 29 00:00 2008"},

		// Daylight savings time 3am EDT (-4) -> 2am EST (-5)
		{"2012-03-11T06:00:00-0400", "TZ=America/New_York 0 30 2 11 Mar *", "2011-03-11T02:30:00-0500"},

		// hourly job
		{"2012-03-11T00:00:00-0500", "TZ=America/New_York 0 30 * * * ?", "2012-03-10T23:30:00-0500"},
		{"2012-03-11T01:00:00-0500", "TZ=America/New_York 0 30 * * * ?", "2012-03-11T00:30:00-0500"},
		{"2012-03-11T03:00:00-0400", "TZ=America/New_York 0 30 * * * ?", "2012-03-11T01:30:00-0500"},
		{"2012-03-11T04:00:00-0400", "TZ=America/New_York 0 30 * * * ?", "2012-03-11T03:30:00-0400"},

		// hourly job using CRON_TZ
		{"2012-03-11T00:00:00-0500", "CRON_TZ=America/New_York 0 30 * * * ?", "2012-03-10T23:30:00-0500"},
		{"2012-03-11T01:00:00-0500", "CRON_TZ=America/New_York 0 30 * * * ?", "2012-03-11T00:30:00-0500"},
		{"2012-03-11T03:00:00-0400", "CRON_TZ=America/New_York 0 30 * * * ?", "2012-03-11T01:30:00-0500"},
		{"2012-03-11T04:00:00-0400", "CRON_TZ=America/New_York 0 30 * * * ?", "2012-03-11T03:30:00-0400"},
		...
		// 2am nightly job (skipped)
		{"2012-03-11T06:00:00-0400", "TZ=America/New_York 0 0 2 * * ?", "2012-03-10T02:00:00-0500"},

		// Daylight savings time 1am EST (-5) => 2am EDT (-4)
		// サマータイム終了はうまく処理できてないっぽい？1:30:00-0500のひとつ前が1:30:00-0400となるのができてなさそう
		{"2012-11-04T01:15:00-0400", "TZ=America/New_York 0 30 1 04 Nov ?", "2011-11-04T01:30:00-0400"},
		...
		// {"2012-11-04T03:00:00-0500", "TZ=America/New_York 0 30 1 04 Nov ?", "2012-11-04T01:30:00-0500"},

		// hourly job
		{"2012-11-04T01:00:00-0400", "TZ=America/New_York 0 30 * * * ?", "2012-11-04T00:30:00-0400"},
		// {"2012-11-04T01:00:00-0500", "TZ=America/New_York 0 30 * * * ?", "2012-11-04T01:30:00-0400"},
		// {"2012-11-04T02:00:00-0500", "TZ=America/New_York 0 30 * * * ?", "2012-11-04T01:30:00-0500"},

		// 1am nightly job (runs twice)
		{"2012-11-04T01:30:00-0400", "TZ=America/New_York 0 0 1 * * ?", "2012-11-04T01:00:00-0400"},
		// {"2012-11-04T01:30:00-0500", "TZ=America/New_York 0 0 1 * * ?", "2012-11-04T01:00:00-0500"},
		// {"2012-11-04T02:30:00-0500", "TZ=America/New_York 0 0 1 * * ?", "2012-11-05T01:00:00-0500"},
		...
		// hourly job
		{"TZ=America/New_York 2012-11-04T01:00:00-0400", "0 30 * * * ?", "2012-11-04T00:30:00-0400"},
		// {"TZ=America/New_York 2012-11-04T01:00:00-0500", "0 30 * * * ?", "2012-11-04T01:30:00-0400"},
		// {"TZ=America/New_York 2012-11-04T02:00:00-0500", "0 30 * * * ?", "2012-11-04T01:30:00-0500"},

		// 1am nightly job (runs twice)
		{"TZ=America/New_York 2012-11-04T01:30:00-0400", "0 0 1 * * ?", "2012-11-04T01:00:00-0400"},
		// {"TZ=America/New_York 2012-11-04T01:30:00-0500", "0 0 1 * * ?", "2012-11-04T01:00:00-0500"},
		// {"TZ=America/New_York 2012-11-04T02:30:00-0500", "0 0 1 * * ?", "2012-11-05T01:00:00-0500"},
		...
		// Test the scenario of DST resulting in midnight not being a valid time.
		// https://github.com/robfig/cron/issues/157
		{"2018-11-17T05:00:00-0500", "TZ=America/Sao_Paulo 0 0 9 10 * ?", "2018-11-10T06:00:00-0500"},
		{"2018-03-14T05:00:00-0500", "TZ=America/Sao_Paulo 0 0 9 22 * ?", "2018-02-22T07:00:00-0500"},
	}
