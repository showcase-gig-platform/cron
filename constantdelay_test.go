...
func TestConstantDelayPrev(t *testing.T) {
	tests := []struct {
		...
		// Wrap around months
		{"Thu Oct 9 00:00 2012", 91*24*time.Hour + 25*time.Minute, "Mon Jul 9 23:35 2012"},
		...
		// Round up to 1 second if the duration is less.
		{"Mon Jul 9 14:45:01 2012", 15 * time.Millisecond, "Mon Jul 9 14:45:00 2012"},

		// Round to nearest second when calculating the next time.
		{"Mon Jul 9 15:00:00.005 2012", 15 * time.Minute, "Mon Jul 9 14:45 2012"},

		// Round to nearest second for both.
		{"Mon Jul 9 15:00:00.005 2012", 15*time.Minute + 50*time.Nanosecond, "Mon Jul 9 14:45 2012"},
	}
